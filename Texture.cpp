                 ...
                 const std::string& path)
{
	...
	createImage(texWidth, texHeight, mipLevels, VK_FORMAT_R8G8B8A8_SRGB, VK_SAMPLE_COUNT_1_BIT, VK_IMAGE_TILING_OPTIMAL,
	            VK_IMAGE_USAGE_TRANSFER_SRC_BIT |
	            VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
	            textureImage, textureImaageMemory, deviceManager.getDevice(), deviceManager.getPhysicalDevice());

	transitionImageLayout(deviceManager.getDevice(), commandPool, deviceManager.getGraphicsQueue(), textureImage,
	                      VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED,
	                      VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, mipLevels);
	copyBufferToImage(deviceManager.getDevice(), commandPool, deviceManager.getGraphicsQueue(), stagingBuffer,
	...
	createTextureSampler(deviceManager);
}
...
void Texture::copyBufferToImage(VkDevice device, VkCommandPool commandPool, VkQueue queue, VkBuffer buffer,
...
void Texture::transitionImageLayout(VkDevice device, VkCommandPool commandPool, VkQueue queue, VkImage image,
...
void Texture::generateMipmaps(DeviceManager& deviceManager, VkCommandPool commandPool, VkImage image,
